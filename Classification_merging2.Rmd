...
strata.size2=c(0,18,28,31,17,5,1)
y.str=y3
...
library(sampling)
strata.train=strata(y.str,stratanames=("AgeGroup"),size=strata.size,method="srswor")
