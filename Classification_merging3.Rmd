...
which(rf.p$test$err.rate[,1]==min(rf.p$test$err.rate[,1]))
...
head(importance(rf.p.2)[order(importance(rf.p),decreasing = T),])
colnames(train[,-c(1:4)])[c(294,632,215,347,126,15)]
